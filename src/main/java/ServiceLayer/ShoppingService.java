...
public class ShoppingService {
    ...
    public Result<Boolean> sendMessage(int storeID, int receiverID, String title, String content) throws Exception
    {
        ...
        if(response){
            ...
            return new Result<Boolean>(true, "Message was not sent");
        }
...
//        return new Result<>(false, receiptServices);
    ...
    public Result<RuleService> addPriceRule(int storeID, int discountID, double minimumPrice)
    {
        try {
    ...
    public Result<RuleService> addQuantityRule(int storeID, int discountID, Map<Integer, Integer> itemsAmounts)
    {
        try {
    ...
    public Result<RuleService> addComposite(int storeID, int discountID, LogicalComposites logicalComposite, List<Integer> logicalComponentsIDs)
    {
        try {
    ...
    public Result<String> finishConditionalDiscountBuilding(int storeID, int discountID)
    {
        try {
